 ...
 * 	demo: https://youtu.be/gUFVUxi9djM
 */
#include <avr/io.h>
...
enum adjusts { start_A, init_A, up, down, upwait, downwait } adjust;
unsigned char freq_timer = 0x02;
void speakerAdjust(){
	unsigned char freq_button = ~PINA & 0x07;
	switch(adjust) {
		case start_A:
			adjust = init_A;
		break;
